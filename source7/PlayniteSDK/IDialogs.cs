...
/// </summary>
public partial class MessageBoxToggle : ObservableObject
{
    /// <summary>
...
/// </summary>
public partial class GlobalProgressActionArgs : ObservableObject
{
    /// <summary>
    ...
    /// </summary>
    [ObservableProperty] private double progressMaxValue = 0;

    /// <summary>
    /// Gets or sets currect value represented on progress track.
    /// </summary>
    [ObservableProperty] private double currentProgressValue = 0;
    ...
    public GlobalProgressActionArgs(SynchronizationContext context, CancellationToken cancelToken)
    {
        UIContext = context;
...
public class ImageFileOption : GenericItemOption
{
    ...
    public ImageFileOption(string path, string name, string? description) : base(name, description)
    {
        Path = path;
    }
}
...
// TODO replace with Avalonia types
...
public interface IDialogs
{
    ...
    StringSelectionDialogResult SelectString(
        string messageBoxText,
        string caption,
        string defaultInput);
